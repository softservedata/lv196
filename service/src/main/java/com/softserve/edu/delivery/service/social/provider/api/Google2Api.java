package com.softserve.edu.delivery.service.social.provider.api;
...
public class Google2Api extends DefaultApi20 {
    ...
    private static class GoogleAccessTokenExtractor implements AccessTokenExtractor {
        @Override
        public Token extract(String response) {
            Preconditions.checkEmptyString(response, "Cannot extract token from an empty string");
